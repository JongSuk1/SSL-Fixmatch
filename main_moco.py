...
from ImageDataLoader import MoCoImageLoader
...
#            nsml.paused(scope=locals())
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                            batch_size=args.batch_size, num_workers=args.workers, pin_memory=True, drop_last=True,
                            sampler=train_sampler)
#    train_loader = torch.utils.data.DataLoader(
#        DATASET_PATH, batch_size=args.batch_size, shuffle=(train_sampler is None),
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, os.path.join('MoCo_Checkpoint', filename))    
    if is_best:
        torch.save(state, os.path.join('MoCo_Checkpoint', 'model_best.pth.tar'))
